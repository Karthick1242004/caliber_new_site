    ...
    >
      {navItems.map((navItem, idx) => (
        <Link
          ...
          href={navItem.link}
          className={cn(
            "relative dark:text-neutral-50 items-center flex space-x-1 text-neutral-100 hover:text-neutral-300 "
          )}
        >
      ...
      <Link href='/users/componentsPage' className="border text-sm font-medium relative border-white/[0.2] text-white px-4 py-2 rounded-full">
        <span>Templates</span>
