...
import cog from '../images/Screenshot 2024-06-21 at 10.52.16 PM.png'
...
export const MacbookScroll = ({
  ...
  return (
    <div ref={ref} className="min-h-[250vh] max-767:min-h-[150vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform scale-100 max-767:scale-75">
      <motion.h2
        style={{
          translateY: textTransform,
          opacity: textOpacity,
        }}
        className=" metallic-text text-6xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          ...
          alt="aceternity logo"
          fill
          className="object-fit object-left-top absolute rounded-lg inset-0 h-full w-full"
        />
      </motion.div>
    </div>
  );
